...
TEST(LLVMTypeAnalyzer_VariableType, IfStatementAfterLoop_SameTypes)
{
    LLVMTypeAnalyzer analyzer;
    LLVMInstructionList list;
    Variable var("", "");
...
TEST(LLVMTypeAnalyzer_VariableType, IfStatementAfterLoop_DifferentTypes)
{
    LLVMTypeAnalyzer analyzer;
    LLVMInstructionList list;
    Variable var("", "");
...
TEST(LLVMTypeAnalyzer_VariableType, TwoIfStatements_DifferentTypes)
{
    LLVMTypeAnalyzer analyzer;
    LLVMInstructionList list;
    Variable var("", "");
    ...
    // Third write - changes type (in else branch)
    auto setVar3 = std::make_shared<LLVMInstruction>(LLVMInstruction::Type::WriteVariable, false);
...
TEST(LLVMTypeAnalyzer_VariableType, CrossVariableDependency_SimpleAssignment)
{
    ...
    auto queryPos = std::make_shared<LLVMInstruction>(LLVMInstruction::Type::FunctionCall, false);
